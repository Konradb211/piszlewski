			...
			<div className='grid grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
				<div className='w-full'>
					<div className='relative'>
						<div className=''>
							<AnimatedOnScroll
								className='grid grid-cols-2 gap-3 sm:gap-4 lg:block lg:relative lg:h-[520px]'
				...
				<div className='w-full'>
					...
					<AnimatedOnScroll animation='animate__fadeInUp'>
						<p className='pb-6 sm:pb-8 text-base leading-relaxed'>
							...
							przemiany aut przed i po detailingu. Znajdziesz tam rolki, zdjęcia
							i relacje z codziennej pracy w studiu – od klasyków po najnowsze
